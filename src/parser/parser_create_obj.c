...
/*   Updated: 2023/09/26 14:57:03 by jkollner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_object	create_camera(char *define_line, int *map, t_window *window)
{
	...
	//	return (free(vec), ft_vecfree(split), map[OBJECT_ERROR]++, (t_object){});
	//return (free(vec), ft_vecfree(split), map[OBJECT_CAMERA]++, (t_object){});
